...
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --job-name=zs_tcmn104
#SBATCH --output=/scratch/siyavash/Alireza_thesis/external_dataset/rsna-intracranial-aneurysm-detection/brain_external_dataset/training/slurm_scripts/zs_tcmn104_%j.log
#SBATCH --error=/scratch/siyavash/Alireza_thesis/external_dataset/rsna-intracranial-aneurysm-detection/brain_external_dataset/training/slurm_scripts/zs_tcmn104_%j.log
...
echo "=== Zero-shot inference: DS104 TCMN → cross-domain ==="
echo "=== $(date) ==="
